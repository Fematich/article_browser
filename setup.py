...
subprocess.call(['python', 'virtualenv', 'flask'])
bin = 'bin'
...
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', 'pandas'])
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', 'redis'])
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', 'bokeh'])
